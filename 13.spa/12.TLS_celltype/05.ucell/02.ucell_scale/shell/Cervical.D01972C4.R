...
D01972C4 <- readRDS("/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/13.spa/05.cell_correct/result/D01972C4/D01972C4_cellbin.final.rds")
data.name <- "Cervical.D01972C4_cellbin"
cell.subset <- D01972C4
...
polygon_sf <- st_read("/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/13.spa/09.cluster_immune/03.net/out/D01972C4.original_polygons.shp")
...
csv.name <- "/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/13.spa/12.TLS_celltype/05.ucell/02.ucell_scale/out/Cervical.D01972C4.UCell.score.csv"
