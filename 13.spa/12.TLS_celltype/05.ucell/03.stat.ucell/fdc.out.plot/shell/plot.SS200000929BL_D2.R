...
index <- "SS200000929BL_D2"
outfix_sample <- "Colorectal.SS200000929BL_D2"

#inpute
RCTD_file <- paste0('/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/13.spa/12.TLS_celltype/05.ucell/03.stat.ucell/fdc.out/SS200000929BL_D2.UCell.score.csv.filter')
...
output_path <- '/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/13.spa/12.TLS_celltype/05.ucell/03.stat.ucell/fdc.out.plot/tls.fdc.plot'
...
plot_function <- function(sf, polygon_sf, aaaa, bbbb, cccc, dddd, eeee, output_file){
   max_value <- aaaa * max(sf$FDC_UCell, na.rm = TRUE)
   min_value <- bbbb * max(sf$FDC_UCell, na.rm = TRUE)
   plot2 <- ggplot() + 
     geom_sf(data = sf, aes(fill = FDC_UCell), color = NA) +
...
output_file <- "/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/13.spa/12.TLS_celltype/05.ucell/03.stat.ucell/fdc.out.plot/tls.fdc.plot/SS200000929BL_D2.png"

plot <- plot_function(sf, polygon_sf,0.8,0,"lightblue","#800080","lightgrey",output_file)
