...
index <- "D01872C5"
outfix_sample <- "Breast.D01872C5"

#inpute
RCTD_file <- paste0('/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/13.spa/12.TLS_celltype/05.ucell/03.stat.ucell/fdc.out/D01872C5.UCell.score.csv.filter')
...
output_file <- "/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/13.spa/12.TLS_celltype/05.ucell/03.stat.ucell/fdc.out.plot/tls.fdc.plot/D01872C5.png"
