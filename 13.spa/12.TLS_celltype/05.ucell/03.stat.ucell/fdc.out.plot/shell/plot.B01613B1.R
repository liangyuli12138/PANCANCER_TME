...
index <- "B01613B1"
outfix_sample <- "Bladder.B01613B1"

#inpute
RCTD_file <- paste0('/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/13.spa/12.TLS_celltype/05.ucell/03.stat.ucell/fdc.out/B01613B1.UCell.score.csv.filter')
...
polygon_sf <- st_read("/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/13.spa/09.cluster_immune/03.net/out/B01613B1.original_polygons.shp")
#first ty.pe的空间分布
...
output_file <- "/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/13.spa/12.TLS_celltype/05.ucell/03.stat.ucell/fdc.out.plot/tls.fdc.plot/B01613B1.png"
