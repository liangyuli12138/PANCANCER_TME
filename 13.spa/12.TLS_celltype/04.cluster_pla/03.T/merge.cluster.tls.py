...
os.chdir("/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/13.spa/12.TLS_celltype/04.cluster_pla/03.T")
...
def process_sample(h5ad_file, csv_file, sample_id):
    ...
    # 筛选出符合条件的细胞
    filtered_cells = annotation[(annotation['celltype'].str.contains('Lymphoid_CD4|Lymphoid_CD8|Lymphoid_ILC|Lymphoid_NK')) & (annotation['LM'] == 'Lymphoid')]
