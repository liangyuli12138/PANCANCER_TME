...
os.chdir("/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/13.spa/12.TLS_celltype/04.cluster_pla/00.all")
...
def process_sample(h5ad_file, csv_file, sample_id):
    ...
    # 筛选出符合条件的细胞
    filtered_cells = annotation[annotation['LM'] == 'Lymphoid']
