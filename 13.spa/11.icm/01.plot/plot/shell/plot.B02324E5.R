...
index <- "B02324E5"
outfix_sample <- "Ovarian.B02324E5"

#inpute
RCTD_file <- paste0('/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/13.spa/11.icm/01.plot/at/B02324E5.all.at')#cell2location结果文件
