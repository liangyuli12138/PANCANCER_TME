...
sc.pl.umap(adata, color=['region_cluster'], size=300, color_map = 'RdPu', ncols = 2, legend_loc='on data',legend_fontsize=10)
plt.savefig("leiden/immune.cluster.r1.png",dpi=300, bbox_inches='tight')
adata.obs.to_csv("leiden/immune.cluster.r1.obs")
adata.write_h5ad("leiden/immune.cluster.r1.h5ad")
