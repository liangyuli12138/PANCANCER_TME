...
expanded_df.to_file('/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/13.spa/09.cluster_immune/03.net_more/out100/B01615B3.expanded_polygons.shp')

# 创建包含原始多边形的GeoDataFrame
original_df = gpd.GeoDataFrame(geometry=original_polygons)

# 将原始多边形保存为shapefile文件
original_df.to_file('/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/13.spa/09.cluster_immune/03.net_more/out100/B01615B3.original_polygons.shp')


# 将结果写入文件
output_file = '/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/13.spa/09.cluster_immune/03.net_more/out100/B01615B3.output.txt'  # 替换为输出文件的路径和名称
...
output_file = '/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/13.spa/09.cluster_immune/03.net_more/out100/B01615B3.output.ex.txt'
with open(output_file, 'w') as f:
    for i, (cluster, size, original_polygon, expanded_polygon) in enumerate(zip(clusters, cluster_sizes, original_polygons, expanded_polygons)):
        # 获取cluster的obs index或第一列id
        cell_ids = []
