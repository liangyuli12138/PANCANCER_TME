...
#inpute
RCTD_file <- paste0('/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/13.spa/09.cluster_immune/04.plot/at.group.zscore.r1/SS200000929BL_D2.group.at')#cell2location结果文件
...
#输出文件夹
output_path <- '/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/13.spa/09.cluster_immune/04.plot/at.group.zscore.r1/plot'


####58个亚类颜色设置#####
color_use <- read.csv('/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/13.spa/09.cluster_immune/04.plot/plot.group/colour.group.list')
...
pdf(paste0(output_path,'/',outfix_sample,'.group_sf.pdf'),w=16,h=8)
plot2
dev.off()
...
#  scale_fill_identity() +
scale_linetype_manual(values = c(polygon = "dashed")) +
             theme_void()+theme(plot.title=element_text(hjust=0.5,vjust=0.5))+ ggtitle(outfix_sample) +
             theme(legend.position="right")
#scale_fill_manual(values = cellType_cols)

png(paste0(output_path,'/',outfix_sample,'.group_sf.png'),res=300,w=8,h=8,units='in')
plot2
dev.off()
