...
#inpute
RCTD_file <- paste0('/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/13.spa/09.cluster_immune/02.data/plot/D01972D1.ori.at')#cell2location结果文件
...
#输出文件夹
output_path <- '/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/13.spa/09.cluster_immune/02.data/plot/plot.ori'
...
png(paste0(output_path,'/',outfix_sample,'.ori_sf.png'),res=300,w=8,h=8,units='in')
plot2
dev.off()
