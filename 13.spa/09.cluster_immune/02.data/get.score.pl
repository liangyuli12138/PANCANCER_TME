...
$dd='/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/13.spa/09.cluster_immune/02.data/score/'.$id.'.at';
...
<$file3>;while(<$file3>){chomp;s/\"//g;@a=split(/,/);$ha{$a[0]}="$a[4],$a[5],$a[6],$a[7]"};
<$file4>;while(<$file4>){chomp;s/\"//g;@a=split(/,/);$hb{$a[0]}=$a[13]};
while(<$file2>){chomp;$hc{$_}="Immune"}

#"Anti.tumor.microenvironment_UCell","Pro.tumor.microenvironment_UCell","angiogenesis.fibrosis_UCell","malignant.cell.properties_UCell"
print $output "cell,region,antiTumor,proTumor,angiogenesis_fibrosis,malignant_properties,hallmarkerEMT,\n";
