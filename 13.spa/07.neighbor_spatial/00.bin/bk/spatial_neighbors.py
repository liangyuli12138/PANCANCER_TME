...
neighbors, shuffled_mean, zscore, nbor_pvals = compute_celltype_neighborhood(adata[adata.obs.group == group], groupby, niter=500, radius=40, permutation_method='local', oneside=True, n_jobs=64)
