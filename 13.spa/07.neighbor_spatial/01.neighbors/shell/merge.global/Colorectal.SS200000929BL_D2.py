...
groupby = "celltype_merge"
adata = sc.read_h5ad(adata)

neighbors, shuffled_mean, zscore, nbor_pvals = compute_celltype_neighborhood(adata, groupby, niter=1000, radius=40, permutation_method='global', oneside=True, n_jobs=2)
...
df.to_csv('/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/13.spa/07.neighbor_spatial/01.neighbors/zscore.out.merge.global/Colorectal.SS200000929BL_D2.out.global.nbor_pvals.csv')
df_to_merge.to_csv('/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/13.spa/07.neighbor_spatial/01.neighbors/zscore.out.merge.global/Colorectal.SS200000929BL_D2.out.global.zscore.csv')
