...
df.to_csv('/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/13.spa/07.neighbor_spatial/01.neighbors/zscore.out.sub.local/Bladder.B01613B1.out.local.nbor_pvals.csv')
df_to_merge.to_csv('/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/13.spa/07.neighbor_spatial/01.neighbors/zscore.out.sub.local/Bladder.B01613B1.out.local.zscore.csv')
