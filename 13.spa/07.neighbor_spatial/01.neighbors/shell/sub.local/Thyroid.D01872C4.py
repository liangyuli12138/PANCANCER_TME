...
neighbors, shuffled_mean, zscore, nbor_pvals = compute_celltype_neighborhood(adata, groupby, niter=1000, radius=40, permutation_method='local', oneside=True, n_jobs=10)
...
df.to_csv('/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/13.spa/07.neighbor_spatial/01.neighbors/zscore.out.sub.local/Thyroid.D01872C4.out.local.nbor_pvals.csv')
df_to_merge.to_csv('/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/13.spa/07.neighbor_spatial/01.neighbors/zscore.out.sub.local/Thyroid.D01872C4.out.local.zscore.csv')
