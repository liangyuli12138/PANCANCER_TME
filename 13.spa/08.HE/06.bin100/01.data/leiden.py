...
df = pd.read_csv("/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/13.spa/08.HE/06.bin100/01.data/bin100.merge.sub.percent.csv", header=0, index_col=0)
