...
df = pd.read_csv("/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/13.spa/08.HE/07.bin100/01.data/bin100.merge.sub.percent.csv.filter", header=0, index_col=0)
...
adata.write_h5ad("bin200.r0.2.h5ad")
...
adata.write_h5ad("bin200.r0.3.h5ad")
...
adata.write_h5ad("bin200.r0.5.h5ad")
...
adata.write_h5ad("bin200.r0.8.h5ad")
...
adata.write_h5ad("bin200.r1.h5ad")
