...
index <- "B02324A1"
outfix_sample <- "Kidney.B02324A1"

#inpute
RCTD_file <- paste0('/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/13.spa/14.icm/01.plot/at/B02324A1.all.at')#cell2location结果文件
