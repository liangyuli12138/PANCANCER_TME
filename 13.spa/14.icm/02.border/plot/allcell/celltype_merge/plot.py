...
os.chdir("/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/13.spa/14.icm/02.border/plot/allcell/celltype_merge")
...
# 获取celltype列下的所有细胞类型
cell_types = filtered_df['celltype_merge'].unique()
...
for cell_type in cell_types:
    ...
    for start, end in ranges:
        cell_count = len(filtered_df[(filtered_df['celltype_merge'] == cell_type) & (filtered_df['distance'] >= start) & (filtered_df['distance'] < end)])
