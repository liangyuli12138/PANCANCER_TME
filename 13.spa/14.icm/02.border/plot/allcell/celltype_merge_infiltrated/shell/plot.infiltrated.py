...
os.chdir("/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/13.spa/14.icm/02.border/plot/allcell/celltype_merge_infiltrated")
data = pd.read_csv('all.cell.dist.csv.type.immune_infiltrated').query("-2000 < distance < 2000")
...
for k, v in mapping.items():
    ...
    ax=sns.lineplot(df_to_plot, x='label', y='ratio', hue='celltype', ax=ax, palette=df_to_plot['Colour'].tolist())
