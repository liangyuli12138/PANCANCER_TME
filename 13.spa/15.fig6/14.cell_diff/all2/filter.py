...
os.chdir("/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/13.spa/15.fig6/14.cell_diff/all2")

adata = sc.read_h5ad("pancancer.icar.all.cell.filter.0527.h5ad")
