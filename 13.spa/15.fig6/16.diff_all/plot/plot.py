...
sc.pl.matrixplot(adata_concat, marker_genes_dict, groupby="new_groups",dendrogram=False, colorbar_title='mean z-score', use_raw=False, vmin=-0.1, vmax=0.1, cmap='RdBu_r',save=".bluk.lym123.diff.zscor.matrixplot.png")
