...
os.chdir("/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/13.spa/15.fig6/05.diff/all3")

adata = sc.read_h5ad("pancancer.icar.all.cell.h5ad")

atlist = pd.read_csv("filter.all.cluster.list.at",index_col=0)
