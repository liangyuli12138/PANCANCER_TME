...
adata_concat = sc.read_h5ad("pancancer.icar.all.cell.mergetype2.h5ad")

marker_genes_dict = {
"Lymphoid_CD4_T_Lymphoid1":["CXCL13"],
"Lymphoid_CD4_T_Lymphoid2":["IL7R"],
"Lymphoid_CD4_T_Lymphoid3":["TNFRSF18"],
}

adata_concat = adata_concat[adata_concat.obs['difftype'].isin(['Lymphoid_CD4_T_Lymphoid1', 'Lymphoid_CD4_T_Lymphoid2','Lymphoid_CD4_T_Lymphoid3']), :]
...
sc.pl.matrixplot(adata_concat, marker_genes_dict, groupby="new_groups",dendrogram=False, colorbar_title='mean z-score', use_raw=False, vmin=-0.1, vmax=0.1, cmap='RdBu_r',save=".cd4t.diff.zscor.matrixplot.0620.png")
