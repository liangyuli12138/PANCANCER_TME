...
adata_concat.write_h5ad("D01972C4_cellbin.final.celltype.h5ad")
adata_concat.obs.to_csv("D01972C4_cellbin.final.celltype.obs.csv")
adata_concat.var.to_csv("D01972C4_cellbin.final.celltype.var.csv")
