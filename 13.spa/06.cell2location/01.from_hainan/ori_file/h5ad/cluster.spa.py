...
os.chdir("/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancancer/08.filter_by_gene/05.cluster_merge/")

adata_concat = sc.read_h5ad("pancancer.final.0314.h5ad")
...
adata_concat.write_h5ad("pancancer.concatenate.filgene.hm.h5ad")
adata_concat.obs.to_csv("pancancer.concatenate.filgene.hm.obs.txt")
adata_concat.var.to_csv("pancancer.concatenate.filgene.hm.var.txt")

sc.pp.neighbors(adata_concat, use_rep = "X_harmony")

adata_concat.write_h5ad("pancancer.concatenate.filgene.hm.neighbors.h5ad")
adata_concat.obs.to_csv("pancancer.concatenate.filgene.hm.neighbors.obs.txt")
adata_concat.var.to_csv("pancancer.concatenate.filgene.hm.neighbors.var.txt")

sc.tl.leiden(adata_concat, key_added='groups',resolution=1.0)

adata_concat.write_h5ad("pancancer.concatenate.filgene.leiden.h5ad")
adata_concat.obs.to_csv("pancancer.concatenate.filgene.leiden.obs.txt")
adata_concat.var.to_csv("pancancer.concatenate.filgene.leiden.var.txt")

sc.tl.umap(adata_concat, min_dist=0.4)

adata_concat.write_h5ad("pancancer.merge.umap.h5ad")
adata_concat.obs.to_csv("pancancer.merge.umap.obs.txt")
adata_concat.var.to_csv("pancancer.merge.umap.var.txt")

sc.pl.umap(adata_concat, color='groups', save= ".cluster.png")
sc.pl.umap(adata_concat, color='groups',  legend_loc='on data', save= ".on.cluster.png")
...
sc.pl.umap(adata_concat, color='groups',  legend_loc='on data', save= ".on.cluster.pdf")
