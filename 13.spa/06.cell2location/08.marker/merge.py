...
marker_genes_dict = {
        ...
        'EC':['VWF','EMCN','PECAM1'],
        'Mural_cell':['MCAM','MYH11'],
        'Fibroblast':['LUM','DCN','FBLN1'],
        'Myeloid':['LYZ','C1QB','LST1'],
        'Mast':['TPSB2','MS4A2','CPA3'],
        'Lymphoid_B':['MS4A1','BANK1'],
        'Plamsa_cell':['MZB1','JCHAIN','IGLL5'],
        'T/NK':['CD3D','TRAC','CCL5'],
}

sc.pl.dotplot(adata_concat, marker_genes_dict, groupby="celltype_sc", dot_max=0.9, categories_order=['Epithelium','EC','Mural_cell','Fibroblast','Myeloid','Mast','Lymphoid_B','Plamsa_cell','T/NK'],vmax=3,
                  save=".cluster.markergene.pdf")
sc.pl.dotplot(adata_concat, marker_genes_dict, groupby="celltype_sc", dot_max=0.9, categories_order=['Epithelium','EC','Mural_cell','Fibroblast','Myeloid','Mast','Lymphoid_B','Plamsa_cell','T/NK'],use_raw=False, colorbar_title="mean z-score", vmin=-2, vmax=2, cmap="RdBu_r",
...
sc.pl.matrixplot(adata_concat, marker_genes_dict, groupby="celltype_sc",dendrogram=False, colorbar_title='mean z-score', use_raw=False, vmin=-2, vmax=2, cmap='RdBu_r',
                  categories_order=['Epithelium','EC','Mural_cell','Fibroblast','Myeloid','Mast','Lymphoid_B','Plamsa_cell','T/NK'],
...
sc.pl.matrixplot(adata_concat, marker_genes_dict, groupby="celltype_sc",dendrogram=False, colorbar_title='mean z-score', use_raw=False, vmin=-1, vmax=2, cmap='RdBu_r',
                  categories_order=['Epithelium','EC','Mural_cell','Fibroblast','Myeloid','Mast','Lymphoid_B','Plamsa_cell','T/NK'],
                  save=".cluster.markergene.zscore.matrix3.pdf")
