...
#inpute
RCTD_file <- paste0('/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/13.spa/13.cluster_immune/04.plot/at_change_colour/B02324E4.all.at')#cell2location结果文件
