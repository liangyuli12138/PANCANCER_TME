...
os.chdir("/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/13.spa/10.cluster_immune/06.more_celltype_cluster/07.gene_20240701/plot")

data = pd.read_csv('group.gene.normalize.mean.group.csv', index_col=0)
...
def plot_box_strip(data, lymphoid_col):
    ...
    ax.set_ylabel('Average normalized expression', fontsize=15)
...
lymphoid_cols = ["CXCL13","CXCR5","FCER2","MS4A1","BCL6","CCL19","CCL21","CCR7","SELL","LAMP3","CXCR4","CD86","CD3D"]
