...
atlist = pd.read_csv("/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/13.spa/10.cluster_immune/07.fig5.stage/07.GC/merge.all.ucell.list.at",index_col=0)
...
sc.pl.umap(adata_concat,color=["GC_ucell"],frameon=False, na_color="grey",save=".Lymphoid_GC_score.cell.pdf")
