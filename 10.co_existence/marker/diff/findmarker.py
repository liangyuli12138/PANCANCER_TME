...
if __name__ == '__main__':
    ...
    cellist = pd.read_csv("/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/10.co_existence/marker/diff/filter.input")
    atlist = pd.read_csv("/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/10.co_existence/marker/diff/filter.at",index_col=0)
    ...
    sc.tl.rank_genes_groups(adata, pts=True,  groupby='time', groups = [cluster], reference='rest', method='t-test')
