...
pheatmap(data,scale="none",fontsize_col=10,fontsize_row=10,border_color = "grey",cluster_rows=T,cluster_cols=T,clustering_method="average",file ='./test.png/output.pearson.average.pdf',width=8,height=10,col=mycolors)
pheatmap(data,scale="none",fontsize_col=10,fontsize_row=10,border_color = "grey",cluster_rows=T,cluster_cols=T,clustering_method="single",file ='./test.png/output.pearson.single.pdf',width=8,height=10,col=mycolors)
pheatmap(data,scale="none",fontsize_col=10,fontsize_row=10,border_color = "grey",cluster_rows=T,cluster_cols=T,clustering_method="complete",file ='./test.png/output.pearson.complete.pdf',width=8,height=10,col=mycolors)
pheatmap(data,scale="none",fontsize_col=10,fontsize_row=10,border_color = "grey",cluster_rows=T,cluster_cols=T,clustering_method="mcquitty",file ='./test.png/output.pearson.mcquitty.pdf',width=8,height=10,col=mycolors)
pheatmap(data,scale="none",fontsize_col=10,fontsize_row=10,border_color = "grey",cluster_rows=T,cluster_cols=T,clustering_method="median",file ='./test.png/output.pearson.median.pdf',width=8,height=10,col=mycolors)
pheatmap(data,scale="none",fontsize_col=10,fontsize_row=10,border_color = "grey",cluster_rows=T,cluster_cols=T,clustering_method="centroid",file ='./test.png/output.pearson.centroid.pdf',width=8,height=10,col=mycolors)
