...
sc.pl.dotplot(adata_concat, marker_genes_dict, groupby="groups_pri",dot_max=0.9, categories_order=["EC_Angiogenic","EC_Artery","EC_Capillary","EC_Vein","EC_Lymph","EC_Alveolar","EC_Glomerular","EC_Sinusoidal",],use_raw=False, colorbar_title="mean z-score", vmin=-1, vmax=1, cmap="RdBu_r",save=".sub.cluster.markergene.EC.pdf")
