...
os.chdir("/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/09.cluster_show/01.all.cluster/oridata_allcancer")
...
cellist = pd.read_csv("merge.all.all.level.eig.input")
adata = adata[cellist["cell"],:]

atlist = pd.read_csv("merge.all.all.level.eig.at",index_col=0)
