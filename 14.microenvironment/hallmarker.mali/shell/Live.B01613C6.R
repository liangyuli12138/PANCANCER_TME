...
reg <- read.csv('/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/13.spa/08.HE/01.Hexcell/region/B01613C6_region.csv')
...
csv.name <- "/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/14.microenvironment/hallmarker.mali/out/Live.B01613C6.UCell.score.csv"
