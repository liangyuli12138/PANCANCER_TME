...
reg <- read.csv('/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/13.spa/08.HE/01.Hexcell/region/B02324A5_region.csv')
...
csv.name <- "/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/14.microenvironment/hallmarker.mali/out/Kidney.B02324A5.UCell.score.csv"
