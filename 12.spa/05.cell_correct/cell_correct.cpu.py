...
parser.add_argument("-d", "--distance", type=int, dest="distance")
...
cl.set_process(20)
correct_mask, exp_matrix = cl.run_fast(distance=distance)
...
exp_matrix.to_csv(correct_out_gem,sep='\t',index=False)
