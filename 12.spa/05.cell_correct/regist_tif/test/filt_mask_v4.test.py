...
mask_path = "/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/12.spa/04.mask.tif.from.qingdao/mask.tif/D01872D1_mask.tif" # cellseg_mask.tif
ssdna_path = "/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/12.spa/05.cell_correct/regist_tif/D01872D1_regist.tif" # regist.tif
...
bright = 4000 # avg_bright threshold of cells
bright = float(bright)
...
for i in range(1,num_labels):
    ...
    if area < 80 or area > 3000:
        ...
        if avg_bright < bright:
            ...
            x = id[1] + x1
            out_img[y,x] = 65535
plt.hist(list, bins=5000, alpha=0.7)
plt.ylim(0, 8000)
plt.xlim(0, 30000)
plt.savefig("/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/12.spa/05.cell_correct/regist_tif/test/test.uint16-3.png")
