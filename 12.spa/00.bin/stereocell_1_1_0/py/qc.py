    ...
    def write_to_ipr(self, ):
        with h5py.File(self.ipr_save_path, 'a') as f:
            ...
            if self.stain_type == 'HE':
                self.tissue_bin_threshold = 0.00001  # TODO: HE tissue bin 阈值， DAPI还是用默认的0.1
...
def main_qc(stain_type, src_data, chip_name, fov_size, magnification, save_dir, debug_mode, zoo_dir, config_path):
    # clog.cl.__init__()
    clog.log2file(
        out_dir=save_dir,
    )
