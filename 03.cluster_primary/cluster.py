...
os.chdir("/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/03.cluster_primary")

adata_concat = sc.read_h5ad("pancancer.ref.0723.raw.h5ad")
...
sc.tl.leiden(adata_concat, key_added='groups',resolution=0.3)
...
adata_concat.write_h5ad("pancancer.ref.umap.0723.h5ad")
adata_concat.obs.to_csv("pancancer.ref.umap.0723.obs.txt")
adata_concat.var.to_csv("pancancer.ref.umap.0723.var.txt")
