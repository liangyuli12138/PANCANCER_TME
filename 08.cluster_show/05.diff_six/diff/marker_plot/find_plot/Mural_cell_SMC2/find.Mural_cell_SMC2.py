...
os.chdir("/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/08.cluster_show/05.diff_six/diff/marker_plot/find_plot/Mural_cell_SMC2");
...
marker_genes_dict=["RAMP1","PALLD","MYLK","TCEAL4","NCAM1","TIMP2","COLEC12","PSAP","CNN1","SFRP4",]
sc.pl.dotplot(adata_concat, marker_genes_dict, groupby="groups_pri", var_group_labels="Mural_cell_SMC2",
                  save="Mural_cell_SMC2.markergene.0.raw.pdf")
