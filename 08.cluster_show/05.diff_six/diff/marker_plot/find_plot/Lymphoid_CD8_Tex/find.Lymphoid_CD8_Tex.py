...
os.chdir("/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/08.cluster_show/05.diff_six/diff/marker_plot/find_plot/Lymphoid_CD8_Tex");
...
marker_genes_dict=["DUSP4","CTLA4","TNFRSF9","RBPJ","RGS1","GAPDH","TIGIT","CD82","CXCL13","LAG3",]
sc.pl.dotplot(adata_concat, marker_genes_dict, groupby="groups_pri", var_group_labels="Lymphoid_CD8_Tex",
                  save="Lymphoid_CD8_Tex.markergene.0.raw.pdf")
