...
os.chdir("/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/08.cluster_show/05.diff_six/diff/marker_plot/find_plot/Mural_cell_SMC1");
...
marker_genes_dict=["ADIRF","MUSTN1","RERGL","PLN","DSTN","SORBS2","CRIP1","NET1","MYH11",]
sc.pl.dotplot(adata_concat, marker_genes_dict, groupby="groups_pri", var_group_labels="Mural_cell_SMC1",
                  save="Mural_cell_SMC1.markergene.0.raw.pdf")
