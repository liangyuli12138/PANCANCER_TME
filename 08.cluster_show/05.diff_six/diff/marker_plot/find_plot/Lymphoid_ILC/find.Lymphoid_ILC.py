...
os.chdir("/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/08.cluster_show/05.diff_six/diff/marker_plot/find_plot/Lymphoid_ILC");
...
marker_genes_dict=["IL4I1","LST1","KIT","TPT1","FXYD5","NFKB1","AHR","NCOA7","AFF3","IL1R1",]
sc.pl.dotplot(adata_concat, marker_genes_dict, groupby="groups_pri", var_group_labels="Lymphoid_ILC",
                  save="Lymphoid_ILC.markergene.0.raw.pdf")
