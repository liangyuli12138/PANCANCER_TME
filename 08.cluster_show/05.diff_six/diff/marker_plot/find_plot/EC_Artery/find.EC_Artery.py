...
os.chdir("/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/08.cluster_show/05.diff_six/diff/marker_plot/find_plot/EC_Artery");
...
marker_genes_dict=["SEMA3G","IGF2","AIF1L","SRP14","CXCL12","GLUL","SRGN","ASS1","KCTD12","FBLN2",]
sc.pl.dotplot(adata_concat, marker_genes_dict, groupby="groups_pri", var_group_labels="EC_Artery",
                  save="EC_Artery.markergene.0.raw.pdf")
