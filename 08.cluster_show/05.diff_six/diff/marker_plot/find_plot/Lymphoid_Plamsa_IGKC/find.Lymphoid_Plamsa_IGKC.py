...
os.chdir("/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/08.cluster_show/05.diff_six/diff/marker_plot/find_plot/Lymphoid_Plamsa_IGKC");
...
marker_genes_dict=["IGHA1","IGHA2","IGHG1","IGHG2","IGHG3","IGHG4","MZB1","XBP1","JCHAIN","PRDM1","SDC1","IGKC","ITM2C",]
sc.pl.dotplot(adata_concat, marker_genes_dict, groupby="groups_pri", var_group_labels="Lymphoid_Plamsa_IGKC",
                  save="Lymphoid_Plamsa_IGKC.markergene.0.raw.pdf")
