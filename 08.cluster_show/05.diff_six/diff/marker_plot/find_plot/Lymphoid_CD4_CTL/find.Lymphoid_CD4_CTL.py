...
os.chdir("/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/08.cluster_show/05.diff_six/diff/marker_plot/find_plot/Lymphoid_CD4_CTL");
...
marker_genes_dict=["GZMA","GZMB","GZMH","GZMK","NKG7","PRF1","ANXA1","ANKRD28","IL7R","CD69","CD40LG","DNAJB1","BTG2","NR4A1","DNAJA1","SRSF7","NR4A2","IFNG",]
sc.pl.dotplot(adata_concat, marker_genes_dict, groupby="groups_pri", var_group_labels="Lymphoid_CD4_CTL",
                  save="Lymphoid_CD4_CTL.markergene.0.raw.pdf")
