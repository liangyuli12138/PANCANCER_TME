...
os.chdir("/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/08.cluster_show/05.diff_six/diff/marker_plot/find_plot/Epithelium_Normal");
...
marker_genes_dict=["MYBPC1","MGP","AZGP1","TAT","SFTPC","AGR3","PHGR1","ERO1B","PIP","GFRA1",]
sc.pl.dotplot(adata_concat, marker_genes_dict, groupby="groups_pri", var_group_labels="Epithelium_Normal",
                  save="Epithelium_Normal.markergene.0.raw.pdf")
