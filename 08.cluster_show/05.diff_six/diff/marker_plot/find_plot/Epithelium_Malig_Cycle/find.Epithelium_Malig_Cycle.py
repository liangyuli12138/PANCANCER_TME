...
os.chdir("/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/08.cluster_show/05.diff_six/diff/marker_plot/find_plot/Epithelium_Malig_Cycle");
...
marker_genes_dict=["TUBA1B","SNRPG","TUBB","PPIA","STMN1","H2AFZ","SNRPD1","HMGN2","PTMA","HMGB1",]
sc.pl.dotplot(adata_concat, marker_genes_dict, groupby="groups_pri", var_group_labels="Epithelium_Malig_Cycle",
                  save="Epithelium_Malig_Cycle.markergene.0.raw.pdf")
