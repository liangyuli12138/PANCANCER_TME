...
os.chdir("/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/08.cluster_show/05.diff_six/diff/marker_plot/find_plot/Lymphoid_CD4_Th17");
...
marker_genes_dict=["IL17A","IL17F","RORA","KLRB1","CCR6","RORC","IL23R","IL22","IL26","CCL20","AHR","JAML","CAPG",]
sc.pl.dotplot(adata_concat, marker_genes_dict, groupby="groups_pri", var_group_labels="Lymphoid_CD4_Th17",
                  save="Lymphoid_CD4_Th17.markergene.0.raw.pdf")
