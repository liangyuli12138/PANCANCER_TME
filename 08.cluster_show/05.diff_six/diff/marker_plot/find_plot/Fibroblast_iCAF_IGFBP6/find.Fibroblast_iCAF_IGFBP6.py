...
os.chdir("/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/08.cluster_show/05.diff_six/diff/marker_plot/find_plot/Fibroblast_iCAF_IGFBP6");
...
marker_genes_dict=["CFD","IGFBP6","SCARA5","S100A4","FBLN2","MFAP5","CCDC80","CHRDL1","PLAC9","GPX3",]
sc.pl.dotplot(adata_concat, marker_genes_dict, groupby="groups_pri", var_group_labels="Fibroblast_iCAF_IGFBP6",
                  save="Fibroblast_iCAF_IGFBP6.markergene.0.raw.pdf")
