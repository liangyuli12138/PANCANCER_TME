...
os.chdir("/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/08.cluster_show/05.diff_six/diff/marker_plot/find_plot/Fibroblast_mCAF_POSTN");
...
marker_genes_dict=["BGN","SPARC","POSTN","TAGLN","CTHRC1","COL1A1","COL3A1","COL8A1","VCAN","COL1A2",]
sc.pl.dotplot(adata_concat, marker_genes_dict, groupby="groups_pri", var_group_labels="Fibroblast_mCAF_POSTN",
                  save="Fibroblast_mCAF_POSTN.markergene.0.raw.pdf")
