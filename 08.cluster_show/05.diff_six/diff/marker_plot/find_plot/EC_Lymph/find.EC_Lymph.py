...
os.chdir("/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/08.cluster_show/05.diff_six/diff/marker_plot/find_plot/EC_Lymph");
...
marker_genes_dict=["MMRN1","TFF3","COLEC12","CCL21","PROX1","LYVE1","S100A10","MARCKS","SHC1",]
sc.pl.dotplot(adata_concat, marker_genes_dict, groupby="groups_pri", var_group_labels="EC_Lymph",
                  save="EC_Lymph.markergene.0.raw.pdf")
