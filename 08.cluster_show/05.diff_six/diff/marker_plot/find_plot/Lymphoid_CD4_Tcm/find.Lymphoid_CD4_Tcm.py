...
os.chdir("/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/08.cluster_show/05.diff_six/diff/marker_plot/find_plot/Lymphoid_CD4_Tcm");
...
marker_genes_dict=["IL7R","GPR183","CCR6","YPEL5","PABPC1","EZR","CD55","SLC2A3","FTH1","CREM",]
sc.pl.dotplot(adata_concat, marker_genes_dict, groupby="groups_pri", var_group_labels="Lymphoid_CD4_Tcm",
                  save="Lymphoid_CD4_Tcm.markergene.0.raw.pdf")
