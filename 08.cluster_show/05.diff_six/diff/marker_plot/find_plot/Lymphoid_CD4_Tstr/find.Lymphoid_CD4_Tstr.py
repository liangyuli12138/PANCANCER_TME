...
os.chdir("/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/08.cluster_show/05.diff_six/diff/marker_plot/find_plot/Lymphoid_CD4_Tstr");
...
marker_genes_dict=["FOS","JUN","IFNG","BAG3","NR4A1","TNF","CCL4","CCL5","CAPG","FOSB","JUNB","DUSP1",]
sc.pl.dotplot(adata_concat, marker_genes_dict, groupby="groups_pri", var_group_labels="Lymphoid_CD4_Tstr",
                  save="Lymphoid_CD4_Tstr.markergene.0.raw.pdf")
