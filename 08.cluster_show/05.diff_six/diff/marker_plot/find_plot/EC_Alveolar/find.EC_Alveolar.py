...
os.chdir("/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/08.cluster_show/05.diff_six/diff/marker_plot/find_plot/EC_Alveolar");
...
marker_genes_dict=["FENDRR","VIPR1","SLC6A4","HPGD","CD82","TMEM100","ACE","TNFSF10","CAV2",]
sc.pl.dotplot(adata_concat, marker_genes_dict, groupby="groups_pri", var_group_labels="EC_Alveolar",
                  save="EC_Alveolar.markergene.0.raw.pdf")
