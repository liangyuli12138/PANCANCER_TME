...
os.chdir("/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/08.cluster_show/05.diff_six/diff/marker_plot/find_plot/Lymphoid_CD8_Tisg");
...
marker_genes_dict=["IFIT3","OASL","IFIT2","LIPA","HERC5","ISG15","IFI44","DDX58","IFIH1","ISG20",]
sc.pl.dotplot(adata_concat, marker_genes_dict, groupby="groups_pri", var_group_labels="Lymphoid_CD8_Tisg",
                  save="Lymphoid_CD8_Tisg.markergene.0.raw.pdf")
