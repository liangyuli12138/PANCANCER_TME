...
os.chdir("/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/08.cluster_show/05.diff_six/diff/marker_plot/find_plot/Fibroblast_mCAF_WNT5A");
...
marker_genes_dict=["TGFBI","TBX3","WNT5A","PRDM1","FBLIM1","TRPA1","IGFBP2","MME","NRG1","COL7A1",]
sc.pl.dotplot(adata_concat, marker_genes_dict, groupby="groups_pri", var_group_labels="Fibroblast_mCAF_WNT5A",
                  save="Fibroblast_mCAF_WNT5A.markergene.0.raw.pdf")
