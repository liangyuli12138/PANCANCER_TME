...
os.chdir("/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/08.cluster_show/05.diff_six/diff/marker_plot/find_plot/Epithelium_Malig_Glandular");
...
marker_genes_dict=["TMED3","RABAC1","TMED9","TTC3","TFF3","AGR2","WFDC2","CKAP4","MUC2",]
sc.pl.dotplot(adata_concat, marker_genes_dict, groupby="groups_pri", var_group_labels="Epithelium_Malig_Glandular",
                  save="Epithelium_Malig_Glandular.markergene.0.raw.pdf")
