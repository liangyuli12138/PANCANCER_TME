...
os.chdir("/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/08.cluster_show/05.diff_six/diff/marker_plot/find_plot/Mural_cell_Pericyte2");
...
marker_genes_dict=["CD44","IGFBP5","GGT5","CCL2","RARRES2","SYNPO2","CLSTN2","CXCL12",]
sc.pl.dotplot(adata_concat, marker_genes_dict, groupby="groups_pri", var_group_labels="Mural_cell_Pericyte2",
                  save="Mural_cell_Pericyte2.markergene.0.raw.pdf")
