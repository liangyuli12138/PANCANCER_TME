...
os.chdir("/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/08.cluster_show/05.diff_six/diff/marker_plot/find_plot/Lymphoid_CD8_Teff");
...
marker_genes_dict=["CCL5","TRGC2","GZMK","CD69","TRDC","IFNG","GZMA","DUSP2","BTG2","TNF",]
sc.pl.dotplot(adata_concat, marker_genes_dict, groupby="groups_pri", var_group_labels="Lymphoid_CD8_Teff",
                  save="Lymphoid_CD8_Teff.markergene.0.raw.pdf")
