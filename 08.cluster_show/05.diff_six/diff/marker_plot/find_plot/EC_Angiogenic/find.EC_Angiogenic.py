...
os.chdir("/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/08.cluster_show/05.diff_six/diff/marker_plot/find_plot/EC_Angiogenic");
...
marker_genes_dict=["INSR","COL4A1","LAMB1","COL4A2","VWA1","PLVAP","RGCC","MCAM","SPARC","IGFBP7",]
sc.pl.dotplot(adata_concat, marker_genes_dict, groupby="groups_pri", var_group_labels="EC_Angiogenic",
                  save="EC_Angiogenic.markergene.0.raw.pdf")
