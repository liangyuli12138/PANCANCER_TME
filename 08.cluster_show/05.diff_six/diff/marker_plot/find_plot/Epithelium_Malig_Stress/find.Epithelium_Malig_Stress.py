...
os.chdir("/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/08.cluster_show/05.diff_six/diff/marker_plot/find_plot/Epithelium_Malig_Stress");
...
marker_genes_dict=["FOSB","JUN","ERCC1","IER2","HSPA1B","EGR1","HSP90AB1","DNAJA1","CLK1","MCL1",]
sc.pl.dotplot(adata_concat, marker_genes_dict, groupby="groups_pri", var_group_labels="Epithelium_Malig_Stress",
                  save="Epithelium_Malig_Stress.markergene.0.raw.pdf")
