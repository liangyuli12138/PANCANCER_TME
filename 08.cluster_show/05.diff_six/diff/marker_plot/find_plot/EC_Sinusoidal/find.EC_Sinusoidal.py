...
os.chdir("/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/08.cluster_show/05.diff_six/diff/marker_plot/find_plot/EC_Sinusoidal");
...
marker_genes_dict=["CTSD","FCN3","CLEC4G","CTSL","SELENOP","TIMP1","FCN2","LGMN","OIT3","ACP5",]
sc.pl.dotplot(adata_concat, marker_genes_dict, groupby="groups_pri", var_group_labels="EC_Sinusoidal",
                  save="EC_Sinusoidal.markergene.0.raw.pdf")
