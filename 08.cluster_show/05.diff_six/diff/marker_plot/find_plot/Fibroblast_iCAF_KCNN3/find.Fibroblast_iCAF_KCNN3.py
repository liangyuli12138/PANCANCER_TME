...
os.chdir("/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/08.cluster_show/05.diff_six/diff/marker_plot/find_plot/Fibroblast_iCAF_KCNN3");
...
marker_genes_dict=["C7","KCNN3","DPT","FXYD6","SCN7A","NDRG2","EGR1","MATN2","MBP","SPARCL1",]
sc.pl.dotplot(adata_concat, marker_genes_dict, groupby="groups_pri", var_group_labels="Fibroblast_iCAF_KCNN3",
                  save="Fibroblast_iCAF_KCNN3.markergene.0.raw.pdf")
