...
os.chdir("/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/07.cluster_secondary/Myeloid/1500_25_1")

adata_concat = sc.read_h5ad("pancancer.ref.0723.final.h5ad")
adata_concat = adata_concat.raw.to_adata()

cellist = pd.read_csv("/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/07.cluster_secondary/at_input/Myeloid.input")
adata_concat = adata_concat[cellist["cell"],:]
atlist = pd.read_csv("/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/07.cluster_secondary/at_input/Myeloid.at",index_col=0)
...
sc.pp.pca(adata_concat, n_comps=25, svd_solver='arpack', use_highly_variable=True)
...
sc.tl.leiden(adata_concat, key_added='groups_secori',resolution=1)

sc.tl.umap(adata_concat, min_dist=0.3)

adata_concat.write_h5ad("pancancer.ref.0807.final.Myeloid.umap.h5ad")
adata_concat.obs.to_csv("pancancer.ref.0807.final.Myeloid.umap.obs.txt")

sc.pl.umap(adata_concat, color='groups_secori', save= ".Myeloid.1500_25_1.cluster.png")
...
"LILRA4","GZMB","CLEC9A","FLT3","IDO1","CD1C","FCER1A","HLA-DQA1","LAMP3","CCR7","FSCN1","FCN1","S100A9","S100A8","FCGR3A","LST1","LILRB2","INHBA","IL1RN",
"CCL4","NLRP3","EREG","IL1B","LYVE1","PLTP","C1QC","C1QA","APOE"                     
],
