...
os.chdir("/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/07.cluster_secondary/Fibroblast/more/aaaa/bbbb_cccc_dddd_eeee")
...
cellist = pd.read_csv("/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/07.cluster_secondary/at_input/aaaa.input")
adata_concat = adata_concat[cellist["cell"],:]
atlist = pd.read_csv("/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/07.cluster_secondary/at_input/aaaa.at",index_col=0)
...
sc.tl.umap(adata_concat, min_dist=eeee)
...
sc.pl.umap(adata_concat, color='groups_secori', save= ".aaaa.bbbb_cccc_dddd_eeee.cluster.png")
sc.pl.umap(adata_concat, color='groups_secori',  legend_loc='on data', save= ".aaaa.bbbb_cccc_dddd_eeee.on.cluster.png")
sc.pl.umap(adata_concat, color="Tissue", save=".aaaa.bbbb_cccc_dddd_eeee.Tissue.cluster.png")
sc.pl.umap(adata_concat, color="Phenotype", save=".aaaa.bbbb_cccc_dddd_eeee.Phenotype.cluster.png")
