...
os.chdir("/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/07.cluster_secondary/aaaa/bbbb_cccc_dddd")
...
sc.pl.umap(adata_concat, color='groups_secori', save= ".aaaa.bbbb_cccc_dddd.cluster.png")
sc.pl.umap(adata_concat, color='groups_secori',  legend_loc='on data', save= ".aaaa.bbbb_cccc_dddd.on.cluster.png")
sc.pl.umap(adata_concat, color="Tissue", save=".aaaa.bbbb_cccc_dddd.Tissue.cluster.png")
sc.pl.umap(adata_concat, color="Phenotype", save=".aaaa.bbbb_cccc_dddd.Phenotype.cluster.png")
