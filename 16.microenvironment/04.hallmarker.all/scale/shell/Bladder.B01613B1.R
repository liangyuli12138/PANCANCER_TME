...
checklist <- read.csv("/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/16.microenvironment/04.hallmarker.all/scale/split/Bladder.B01613B1.UCell.score.csv",header=TRUE)
