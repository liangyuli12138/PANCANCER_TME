...
checklist <- read.csv("/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/16.microenvironment/02.subtypes.all/scale/split/Breast.D01872C5.UCell.score.csv",header=TRUE)
...
#csv.name <- "/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/16.microenvironment/02.subtypes.all/out/Breast.D01872C5.UCell.score.csv"
