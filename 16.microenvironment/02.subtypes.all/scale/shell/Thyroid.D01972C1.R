...
checklist <- read.csv("/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/16.microenvironment/02.subtypes.all/scale/split/Thyroid.D01972C1.UCell.score.csv",header=TRUE)
...
#csv.name <- "/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/16.microenvironment/02.subtypes.all/out/Thyroid.D01972C1.UCell.score.csv"
