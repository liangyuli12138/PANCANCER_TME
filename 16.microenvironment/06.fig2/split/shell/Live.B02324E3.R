...
checklist <- read.csv("/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/16.microenvironment/06.fig2/split/split/Live.B02324E3.UCell.score.csv",header=TRUE)
