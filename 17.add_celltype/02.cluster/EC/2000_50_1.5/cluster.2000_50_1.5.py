...
os.chdir("/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/17.add_celltype/02.cluster/EC/2000_50_1.5")
...
adata_concat.write_h5ad("pancancer.ref.0723.final.EC.umap.h5ad")
adata_concat.obs.to_csv("pancancer.ref.0723.final.EC.umap.obs.txt")
adata_concat.var.to_csv("pancancer.ref.0723.final.EC.umap.var.txt")
