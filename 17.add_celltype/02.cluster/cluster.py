...
os.chdir("/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/17.add_celltype/02.cluster/aaaa/bbbb_cccc_dddd")

adata_concat = sc.read_h5ad("pancancer.ref.0723.final.aaaa.h5ad")
...
adata_concat.write_h5ad("pancancer.ref.0723.final.aaaa.umap.h5ad")
adata_concat.obs.to_csv("pancancer.ref.0723.final.aaaa.umap.obs.txt")
adata_concat.var.to_csv("pancancer.ref.0723.final.aaaa.umap.var.txt")
