...
os.chdir("/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/05.cluster_secondary_filter/05.cluster/CD4_pca_filter/aaaa/bbbb_cccc_dddd")
...
adata_concat.write_h5ad("pancancer.ref.0904.final.aaaa.umap.h5ad")
adata_concat.obs.to_csv("pancancer.ref.0904.final.aaaa.umap.obs.txt")
adata_concat.var.to_csv("pancancer.ref.0904.final.aaaa.umap.var.txt")
