...
os.chdir("/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/05.cluster_secondary_filter/05.cluster/CD8_pca/CD8_pca/2000_50_1.5")
...
adata_concat.write_h5ad("pancancer.ref.0807.final.CD8_pca.umap.h5ad")
adata_concat.obs.to_csv("pancancer.ref.0807.final.CD8_pca.umap.obs.txt")
adata_concat.var.to_csv("pancancer.ref.0807.final.CD8_pca.umap.var.txt")
