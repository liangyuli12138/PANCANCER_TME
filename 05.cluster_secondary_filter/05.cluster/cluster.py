...
os.chdir("/zfssz2/ST_TSCBI/P22Z10200N0433/USER/wubin2/wubin2/pancnew/05.cluster_secondary_filter/05.cluster/aaaa/bbbb_cccc_dddd")

adata_concat = sc.read_h5ad("pancancer.ref.0804.final.aaaa.umap.h5ad")
